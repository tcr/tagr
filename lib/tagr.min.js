...
2;d++)this.h("insert",d,arguments[d+2]);return c};O.prototype.push=function(){return this.H.apply(this,[this.length,r(arguments)])};O.prototype.pop=function(){return this.remove(this.length-1)};O.prototype.unshift=function(){return this.H.apply(this,[0].concat(arguments))};O.prototype.shift=function(){return this.remove(0)};O.prototype.sort=function(){};O.prototype.reverse=function(){};
