...
E.prototype.persist=function(a){this.g[a]=j};E.prototype.stopPersisting=function(a){this.g[a]=!0};E.prototype.splice=function(a,b){for(var c=0;c<b;c++)"string"!=typeof this[a+c]&&(this[a+c].parent=g);for(c=0;c<arguments.length-2;c++){var d=arguments[c+2];"string"!=typeof d&&(d.parent=this)}d=Array.prototype.splice.apply(this,arguments);for(c=0;c<arguments.length-2;c++)this.h("insert",a+c,arguments[c+2]);return d};
