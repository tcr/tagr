...
b.style.left="font-size"===a?"1em":c||0,c=b.style.pixelLeft+"px",e=[e,d],b.style.left=e[0],b.runtimeStyle.left=e[1]),c};B=function(){var b;b=function(){var a;if(document.querySelector!=o)return function(a,b){return a.querySelectorAll(b)};if(document.documentElement.currentStyle!=o)return a=new A,function(c,b){var d,f;d=(f=b.match(z))!=o?f[1]:h;a.addRule(b,"foo:bar");var i,m,j;m=d?c.V(d):c.all;j=[];f=0;for(i=m.length;f<i;f++)d=m[f],"bar"===d.currentStyle.F&&j.push(d);a.removeRule(0);return j}}();return function(a,
c){return"undefined"!==typeof Sizzle?Sizzle(c,a):b(a,c)}}();s=function(){var b;b=0;return function(a){var c;return(c=a.s)!=o?c:a.s=b++}}();v=function(){function b(){this.g={}}b.name="DomMap";b.prototype.set=function(a,c){return this.g[s(a)]=c};b.prototype.get=function(a){return this.g[s(a)]};b.prototype.remove=function(a){return delete this.g[s(a)]};return b}();z=/(?:^|\s+)([^.#\[\]:\s]*)(\S*)\s*$/;H=/([:#.]+)([^:#.]+)/g;K=function(b){var a,c,e,d;if(a=b.match(z)){b={n:a[1]||"div",h:[],id:o};d=a[2].match(H)||
[];c=0;for(e=d.length;c<e;c++)switch(a=d[c],a[0]){case "#":b.id=a.substr(1);break;case ".":b.h.push(a.substr(1))}return b}};this.tagr=g=function(b,a){var c,e;a==o&&(a={});e=K(b||"");c=document.createElement(e.n);e.h.length&&(c.className=e.h.join(" "));e.id&&(c.id=e.id);return(new p(c)).set(a)};g.t=["data-tagr"];g.parse=function(b){var a,c,e,d,f;if("string"===typeof b)return b;d=b[0];e=b[1];c=3<=b.length?l.call(b,2):[];return(f=g(d,e)).append.apply(f,function(){var b,d,e;e=[];b=0;for(d=c.length;b<
...
return this};a.prototype.removeSelf=function(){this.parent.remove(this.index());return this};a.prototype.insertSelf=function(a,b){a.insert(b,this);return this};a.prototype.index=function(){return this.parent.indexOf(this)};a.prototype.select=function(a){return new g.TagrQuery(this,a)};a.prototype.find=function(a){return this.select(a).find()};a.prototype.toJSON=function(){var a;return[this.n,this.w].concat(l.call(function(){var b,d,f;f=[];b=0;for(d=this.length;b<d;b++)a=this[b],f.push("string"===
typeof a?a:a.toJSON());return f}.call(this)))};return a}(x);E=["forEach","slice","map","indexOf"];v=function(b){p.prototype[b]=function(){var a;a=1<=arguments.length?l.call(arguments,0):[];return Array.prototype[b].apply(this,a)}};q=0;for(M=E.length;q<M;q++)n=E[q],v(n);g.TagrQuery=function(){var b,a;a={};b=function(b){var e;b==o&&(b="all");if(a[b]!=o)return a[b];e=new A(b);return a[b]=e.sheet||e.styleSheet};return function(a){function e(a,c){var e=this;this.d=a;this.k=c;this.style=new u(this,{set:w(C(D(function(a,
c){var d,f;d="[data-tagr='"+e.d.q()+"'] "+e.k;f=b();f.insertRule(""+d+" { "+a+": "+c+" }",f.cssRules.length);return e})))})}F(e,a);e.name="TagrQuery";e.prototype.addListener=function(a,b){var c=this;this.d.a.addEventListener(a,function(a){var d,e;d=B(c.d.a,c.k);n=a.target;for(e=[];n!==c.d.a&&n;)0<=O.call(d,n)&&b.call(g.c(n),a),e.push(n=n.parentNode);return e},!1);return e.m.addListener.call(this,a,b)};e.prototype.find=function(){var a,b,c,e,j;e=B(this.d.a,this.k);j=[];b=0;for(c=e.length;b<c;b++)a=
e[b],j.push(g.c(a));return j};return e}(x)}();G=function(){function b(a,b){this.j=a;this.i=b}b.name="ElementAnchor";b.prototype.l=function(){return[this.j.a,this.i]};return b}();I=function(){function b(a,b,e){this.j=a;this.r=b;this.i=e}b.name="TextAnchor";b.prototype.l=function(){return[this.j.a.childNodes[this.r],this.i]};return b}();r=function(b){var a,c;c=b[0];b=b[1];if(1===c.nodeType)return!(a=g.c(c))?h:new G(a,b);if(g.c(c.parentNode)){a=0;for(n=c;n.previousSibling;)n=n.previousSibling,a++;return new I(el,
a,b)}};g.view={getBox:function(b,a){var c,e,d,f;c=b.a.getBoundingClientRect();if(a!=o)for(e in f=a.a.getBoundingClientRect(),f)d=f[e],c[e]-=d;return c},getStyle:function(b,a){return J(b.a,a)},selection:{has:function(){return Selection.M(window)},getOrigin:function(){return r(Selection.K(window))},getFocus:function(){return r(Selection.J(window))},getStart:function(){return r(Selection.L(window))},getEnd:function(){return r(Selection.I(window))},set:function(b,a){return Selection.T.apply(Selection,
[window].concat(l.call(b.l()),l.call(a.l())))},remove:function(){return Selection.B(window)}}};p.prototype.useWhitespace=function(b){b==o&&(b=!0);return b?this.style.set({"white-space":["pre","pre-wrap","-moz-pre-wrap","-pre-wrap","-o-pre-wrap"],"word-wrap":"break-word"}):this.style.set(["white-space","word-wrap"],"")};p.prototype.setSelectable=function(b){b==o&&(b=!0);return this.style.set("-webkit-touch-callout,-webkit-user-select,-khtml-user-select,-moz-user-select,-ms-user-select,user-select".split(","),
b?"":"none")}}).call(this);
