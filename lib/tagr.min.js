...
i(e=a.split(","),ea(c,function(a,b){l=a.a.querySelectorAll(b);1==l.length?d[d.length]=l.item(0):l.length&&(d=d.concat(o(l)))}));return 1<e.length&&1<d.length?V(d):d}catch(f){}return b(a,c)}function d(a,b){return b!==a&&b.a.contains(a.a)}function e(){this.s={}}function f(a){return ga.c(a)||ga.d(a,"(^|\\s+)"+a+"(\\s+|$)",1)}function i(a,b){for(var c=0,d=a.length;c<d;c++)b(a[c])}function h(a){for(var b=[],c=0,d=a.length;c<d;++c)W(a[c])?b=b.concat(a[c]):b[b.length]=a[c];return b}function o(a){for(var b=
...
void 0},d:function(a,b,c){b=c?RegExp(b):b;return this.s[a]=b}};var ga=new e,ia=new e,m=new e,w=new e,La=!!H[oa],za=H.querySelector&&H.querySelectorAll;a({X:!0});z.M=a;z.W=V;z.T=function(a,b,c){if(G(b))return a==b;if(W(b))return!!~h(b).indexOf(a);for(var d=b.split(","),e;b=d.pop();)if(e=w.c(b)||w.d(b,b.split(ja)),b=b.match(ka),e=e.slice(0),Y.apply(a,X(e.pop()))&&(!e.length||na(a,e,b,c)))return!0;return j};z.A={};return z}
...
function E(a){this.t=a;var b=this;a.w("change:class",function(a){b.splice(0,b.length);ba(a)&&b.push.apply(b,ba(a).split(/\s+/))})}function F(a){this.e=a;this.b={};this.j={};this.g={};this.classList=new E(this)}function I(a,b){this.p=a;this.o=b}function K(a,b,c){this.p=a;this.G=b;this.o=c}function L(a,b){this.i=a;this.l=b;this.j={}}
...
var Ra="area base br col command embed hr img input keygen link meta param source track wbr".split(" "),sa=/(?:^|\s+)([^.#\[\]:\s]*)(\S*)\s*$/,ta=/([:#.]+)([^:#.]+)/g;v(E,[]);E.prototype.contains=function(a){return 0<=aa(this,String(a))};E.prototype.add=function(a){this.contains(a)||this.t.set("class",a+" "+this)};E.prototype.remove=function(a){for(var b="",c=0,d;d=this[c++];)d!=String(a)&&(b+=d+" ");this.t.set("class",b)};E.prototype.toggle=function(a){this.contains(a)?this.add(a):this.remove(a)};
...
var O={m:{},set:function(a,b){return O.m[$(a)]=b},get:function(a){return O.m[$(a)]},remove:function(a){return delete O.m[$(a)]}};function P(a,b,c){this.a=b||c.document.createElement(a);F.call(this,a)}v(P,F.prototype);P.prototype.B=function(a){this.parent=a;O.set(this.a,this)};P.prototype.C=function(){delete this.parent;O.remove(this.a)};P.prototype.n="";P.prototype.r=function(){this.n||(this.a.className+=" "+(this.n="tagr-"+$(this.a)));return this.n};
...
M.prototype.addListener=function(a,b){var c=this;this.i.w(a,function(a){for(var e=queryr(c.l,c.i),f=p.getContext(a.target||a.srcElement);f!=c.i&&f;f=f.parent)-1<aa(e,f)&&b.call(f,a)});return L.prototype.addListener.call(this,a,b)};p=Pa?Oa(window):xa();"undefined"!==typeof module&&(module.u=p);
