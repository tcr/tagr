...
M.prototype.addListener=function(a,b){var c=this;this.i.w(a,function(a){for(var e=queryr(c.l,c.i),f=p.getContext(a.target||a.srcElement);f!=c.i&&f;f=f.parent)-1<aa(e,f)&&b.call(f,a)});return L.prototype.addListener.call(this,a,b)};p=Pa?Oa(window):xa();"undefined"!==typeof module&&(module.o=p,module.o.V=__dirname);
