...
e=d[0],d=d[1],b.runtimeStyle.left=b.currentStyle.left,b.style.left="font-size"===a?"1em":c||0,c=b.style.pixelLeft+"px",e=[e,d],b.style.left=e[0],b.runtimeStyle.left=e[1]),c};A=function(){var b;b=function(){var a;if(document.querySelector!=g)return function(a,b){return a.querySelectorAll(b)};if(document.documentElement.currentStyle!=g)return a=new z,function(c,b){var d,f;d=(f=b.match(y))!=g?f[1]:void 0;a.addRule(b,"foo:bar");var h,k,i;k=d?c.K(d):c.all;i=[];f=0;for(h=k.length;f<h;f++)d=k[f],"bar"===
d.currentStyle.z&&i.push(d);a.removeRule(0);return i}}();return function(a,c){return"undefined"!==typeof Sizzle?Sizzle(c,a):b(a,c)}}();r=function(){var b;b=0;return function(a){var c;return(c=a.o)!=g?c:a.o=b++}}();u=function(){function b(){this.g={}}b.name="DomMap";b.prototype.set=function(a,c){return this.g[r(a)]=c};b.prototype.get=function(a){return this.g[r(a)]};b.prototype.remove=function(a){return delete this.g[r(a)]};return b}();y=/(?:^|\s+)([^.#\[\]:\s]*)(\S*)\s*$/;F=/([:#.]+)([^:#.]+)/g;H=
function(b){var a,c,e,d;if(a=b.match(y)){b={k:a[1]||"div",h:[],id:g};d=a[2].match(F)||[];c=0;for(e=d.length;c<e;c++)switch(a=d[c],a[0]){case "#":b.id=a.substr(1);break;case ".":b.h.push(a.substr(1))}return b}};this.tagr=j=function(b,a){var c,e;a==g&&(a={});e=H(b||"");c=document.createElement(e.k);e.h.length&&(c.className=e.h.join(" "));e.id&&(c.id=e.id);return(new p(c)).set(a)};j.p=["data-tagr"];j.parse=function(b){var a,c,e,d,f;if("string"===typeof b)return b;d=b[0];e=b[1];c=3<=b.length?m.call(b,
2):[];return(f=j(d,e)).append.apply(f,function(){var b,d,e;e=[];b=0;for(d=c.length;b<d;b++)a=c[b],e.push(j.parse(a));return e}())};j.ready=q;j.d=new u;j.e=function(b,a){var c;a==g&&(a=!1);if(1!==b.nodeType)throw Error("Cannot create Tagr context of non-element");if((c=j.d.get(b))==g){if(!a)throw Error("No Tagr wrapper exists for this element.");j.d.set(b,c=new p(b))}return c};j.getContext=function(b){return j.e(b,!0)};j.writeContext=function(b,a){var c;b==g&&(b="div");a==g&&(a={});document.write("<"+
b+"></"+b+">");c=document.getElementsByTagName(b);return j.getContext(c[c.length-1]).set(a)};j.TagrElement=p=function(b){function a(c,b){var d,f,h,k,i,l=this;this.a=c;this.parent=b;this.tag=this.a.nodeName.toLowerCase();this.classes=new t(this,{set:function(a,c){var b;c==g&&(c=!0);return l.a.className=function(){var c,d,e,f;e=this.classes;f=[];c=0;for(d=e.length;c<d;c++)b=e[c],b!==a&&f.push(b);return f}.call(l).join("")+(c?" "+a:"")},get:function(a){return!!l.a.className.match(RegExp("\\b"+a+"\\b"))},
remove:function(a){var c;return l.a.className=function(){var b,d,e,f;e=this.classes;f=[];b=0;for(d=e.length;b<d;b++)c=e[b],c!==a&&f.push(c);return f}.call(l).join("")}});k=this.a.className.match(/\S+/g)||[];f=0;for(h=k.length;f<h;f++)d=k[f],this.classes.set(d);this.style=new t(this,{set:function(a,c){return l.a.style[s(a)]=c},get:function(a){return l.a.style[s(a)]},remove:function(a){return delete l.a.style[s(a)]}});this.length=this.a.childNodes.length;i=this.a.childNodes;f=h=0;for(k=i.length;h<k;f=
++h)d=i[f],this[f]=1===d.nodeType?new a(d,this):d.q}E(a,b);a.name="TagrElement";a.prototype.l=function(a){this.parent=a;j.d.set(this.a,this)};a.prototype.m=function(){delete this.parent;j.d.remove(this.a)};a.prototype.n=function(){this.a.hasAttribute("data-tagr")||this.a.setAttribute("data-tagr",r(this.a));return this.a.getAttribute("data-tagr")};a.prototype.get=function(a){var b;return this.a[(b=x[a])!=g?b:a]};a.prototype.set=v(function(a,b){var d;this.emit("change:"+a,b);this.a[(d=x[a])!=g?d:a]=
b;return this});a.prototype.remove=function(a){this.a.removeAttribute(a);return this};a.prototype.addListener=function(b,e){var d=this;this.a.addEventListener?this.a.addEventListener(b,function(a){return d.emit(b,a)},!1):this.a.attachEvent&&this.a.attachEvent("on"+b(function(){return d.emit(b,window.event)}));return a.j.addListener.call(this,b,e)};a.prototype.splice=function(){var a,b,d,f,h,k,i,l;d=arguments[0];b=arguments[1];a=3<=arguments.length?m.call(arguments,2):[];for(f=h=0;0<=b?h<b:h>b;f=0<=
b?++h:--h)this.a.removeChild(this.a.childNodes[d]),"object"===typeof this[d+f]&&this[d+f].m();k=this.a.childNodes[d];f=i=0;for(l=a.length;i<l;f=++i){h=a[f];"object"===typeof h?(h.constructor===Array&&(h=a[f]=j.parse(h)),f=h.a):f=document.createTextNode(h);if(f.parentNode)throw Error("Must remove element before appending elsewhere.");this.a.insertBefore(f,k);"object"===typeof h&&h.l(this)}return I.apply(g,[this,d,b].concat(m.call(a)))};a.prototype.append=function(){var a;a=1<=arguments.length?m.call(arguments,
0):[];this.splice.apply(this,[this.length,0].concat(m.call(a)));return this};a.prototype.prepend=function(){var a;a=1<=arguments.length?m.call(arguments,0):[];this.splice.apply(this,[0,0].concat(m.call(a)));return this};a.prototype.remove=function(a){this.splice(a,1);return this};a.prototype.insert=function(){var a,b;b=arguments[0];a=2<=arguments.length?m.call(arguments,1):[];this.splice.apply(this,[b,0].concat(m.call(a)));return this};a.prototype.empty=function(){this.splice(0,this.length);return this};
a.prototype.appendSelf=function(a){a.append(this);return this};a.prototype.prependSelf=function(a){a.prepend(this);return this};a.prototype.removeSelf=function(){this.parent.remove(this.index());return this};a.prototype.insertSelf=function(a,b){a.insert(b,this);return this};a.prototype.index=function(){return this.parent.indexOf(this)};a.prototype.select=function(a){return new j.TagrQuery(this,a)};a.prototype.find=function(a){return this.select(a).find()};a.prototype.toJSON=function(){var a;return[this.k,
this.s].concat(m.call(function(){var b,d,f;f=[];b=0;for(d=this.length;b<d;b++)a=this[b],f.push("string"===typeof a?a:a.toJSON());return f}.call(this)))};return a}(w);D=["forEach","slice","map","indexOf"];u=function(b){p.prototype[b]=function(){var a;a=1<=arguments.length?m.call(arguments,0):[];return Array.prototype[b].apply(this,a)}};q=0;for(J=D.length;q<J;q++)n=D[q],u(n);j.TagrQuery=function(){var b,a;a={};b=function(b){var e;b==g&&(b="all");if(a[b]!=g)return a[b];e=new z(b);return a[b]=e.sheet||
e.styleSheet};return function(a){function e(a,c){var e=this;this.c=a;this.i=c;this.style=new t(this,{set:v(B(C(function(a,c){var d,f;d="[data-tagr='"+e.c.n()+"'] "+e.i;f=b();f.insertRule(""+d+" { "+a+": "+c+" }",f.cssRules.length);return e})))})}E(e,a);e.name="TagrQuery";e.prototype.addListener=function(a,b){var c=this;this.c.a.addEventListener(a,function(a){var d,e;d=A(c.c.a,c.i);n=a.target;for(e=[];n!==c.c.a&&n;)0<=L.call(d,n)&&b.call(j.e(n),a),e.push(n=n.parentNode);return e},!1);return e.j.addListener.call(this,
a,b)};e.prototype.find=function(){var a,b,c,e,i;e=A(this.c.a,this.i);i=[];b=0;for(c=e.length;b<c;b++)a=e[b],i.push(j.e(a));return i};return e}(w)}();j.view={getBox:function(b,a){var c,e,d,f;c=b.a.getBoundingClientRect();if(a!=g)for(e in f=a.a.getBoundingClientRect(),f)d=f[e],c[e]-=d;return c},getStyle:function(b,a){return G(b.a,a)}};p.prototype.useWhitespace=function(b){b==g&&(b=!0);return b?this.style.set({"white-space":["pre","pre-wrap","-moz-pre-wrap","-pre-wrap","-o-pre-wrap"],"word-wrap":"break-word"}):
this.style.set(["white-space","word-wrap"],"")};p.prototype.setSelectable=function(b){b==g&&(b=!0);return this.style.set("-webkit-touch-callout,-webkit-user-select,-khtml-user-select,-moz-user-select,-ms-user-select,user-select".split(","),b?"":"none")}}).call(this);
