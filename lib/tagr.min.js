...
b},get:function(a){return l.a.style[o(a)]},remove:function(a){return delete l.a.style[o(a)]}});this.length=this.a.childNodes.length;k=this.a.childNodes;f=g=0;for(j=k.length;g<j;f=++g)d=k[f],this[f]=1===d.nodeType?new a(d,this):d.t}C(a,b);a.name="Tagr";a.prototype.h=function(a){this.parent=a;g.d.set(this.a,this)};a.prototype.i=function(){delete this.parent;g.d.remove(this.a)};a.prototype.j=function(){this.a.hasAttribute("data-tagr")||this.a.setAttribute("data-tagr",n(this.a));return this.a.getAttribute("data-tagr")};
