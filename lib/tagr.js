...
(function() {
  var ArrayHash, DomMap, EventEmitter, HTML_DOM_PROPS, Script, Stylesheet, Tagr, TagrList, TagrQuery, addDomReadyListener, findSelector, fromCamelCase, getComputedStyle, getElementUUID, n, tagr, toCamelCase, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  findSelector = (function() {
    var sheet;
    if (!(document.documentElement.querySelector != null) && (document.documentElement.currentStyle != null)) {
      sheet = new Stylesheet();
      return function(root, selector) {
        var res, tag, x, _ref;
        tag = (_ref = selector.match(/(?:^|\s+)([^.#:\s]+)(?:[.#:]+[^:.#()\s]+)*\s*$/)) != null ? _ref[1] : void 0;
        sheet.addRule(selector, 'foo:bar');
        res = (function() {
          var _i, _len, _ref1, _results;
          _ref1 = (tag != null ? root.tags(tag) : root.all);
          _results = [];
  ...
  ArrayHash = (function() {
    ...
    ArrayHash.prototype.get = function(k) {
      var _ref;
      if (((_ref = this.handlers) != null ? _ref.get : void 0) != null) {
        return this.handlers.get(k);
      } else {
        return this.hash['@' + k];
      }
    };

    ArrayHash.prototype.set = function(k, v) {
      var ak, av, _i, _len, _ref;
      if (typeof k === 'object') {
        for (ak in k) {
          av = k[ak];
          this.set(ak, av);
      ...
      if (!Object.prototype.hasOwnProperty.call(this.hash, '@' + k)) {
        this[this.length++] = k;
      }
    ...
    ArrayHash.prototype.remove = function(k) {
      var i, j, tk, _i, _j, _len, _ref, _ref1;
      if (!Object.prototype.hasOwnProperty.call(this.hash, '@' + k)) {
        return this.chain;
      }
      for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
        ...
        for (j = _j = i, _ref = this.length - 1; i <= _ref ? _j < _ref : _j > _ref; j = i <= _ref ? ++_j : --_j) {
          this[j] = this[j + 1];
        }
        break;
      }
      this.length--;
      if ((_ref1 = this.handlers) != null) {
        if (typeof _ref1.remove === "function") {
          _ref1.remove(k);
        }
      }
      delete this.hash['@' + k];
  ...
  tagr.Tagr = Tagr = (function(_super) {
    ...
    function Tagr(_node, parent) {
      ...
      this.classes = new ArrayHash(this, {
        set: function(k, v) {
          ...
          return _this._node.className = "" + (((function() {
            ...
            _ref1 = (_ref = this._node.className.match(/\S+/g)) != null ? _ref : [];
            _results = [];
            for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
              c = _ref1[_i];
              if (c !== k) {
      ...
      this.style = new ArrayHash(this, {
        set: function(k, v) {
          return _this._node.style[k] = v;
        },
        get: function(k) {
          return _this._node.style[k];
        },
        remove: function(k) {
          return delete _this._node.style[k];
        }
      });
    ...
    Tagr.prototype.get = function(k) {
      var _ref;
      return this._node[(_ref = HTML_DOM_PROPS[k]) != null ? _ref : k];
    };

    Tagr.prototype.set = function(k, v) {
      var ak, av, _ref;
      if (typeof k === 'object') {
        for (ak in k) {
          av = k[ak];
      ...
      return this._node[(_ref = HTML_DOM_PROPS[k]) != null ? _ref : k] = v;
    };

    Tagr.prototype.remove = function(k) {
      return this._node.removeAttribute(k);
    };
  ...
  tagr.TagrQuery = TagrQuery = (function(_super) {
    ...
    function TagrQuery(ctx, selector) {
      ...
      this.style = new ArrayHash(this, {
        set: function(k, v) {
          var fullSelector, s;
          fullSelector = "[data-tagr='" + (_this.ctx._ensureAttrUuid()) + "'] " + _this.selector;
          s = getStylesheet();
    ...
    TagrQuery.prototype.addListener = function(type, f) {
      ...
      this.ctx._node.addEventListener(type, (function(e) {
        ...
        matches = findSelector(_this.ctx._node, _this.selector);
        n = e.target;
        _results = [];
    ...
    TagrQuery.prototype.find = function() {
      ...
      _ref1 = findSelector(this.ctx._node, this.selector);
      _results = [];
  ...
  tagr.TagrList = TagrList = (function() {
    ...
    function TagrList() {
      ...
      this.attrs = new ArrayHash(this, {
        set: function(k, v) {
          var t, _k, _len2, _results;
          _results = [];
          for (_k = 0, _len2 = _this.length; _k < _len2; _k++) {
            t = _this[_k];
            _results.push(t.set(k, v));
          }
          return _results;
        }
      });
      this.styles = new ArrayHash(this, {
        set: function(k) {
          var t, _k, _len2, _results;
          _results = [];
          for (_k = 0, _len2 = _this.length; _k < _len2; _k++) {
            t = _this[_k];
            _results.push(t.style.set(k));
          }
          return _results;
        },
        remove: function(k) {
          ...
          for (_k = 0, _len2 = _this.length; _k < _len2; _k++) {
            t = _this[_k];
            _results.push(t.style.remove(k));
          }
          return _results;
        }
      });
  ...
  Tagr.prototype.getSelection = function() {};
