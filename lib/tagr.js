...
(function() {
  var ArrayHash, DomMap, EventEmitter, Script, Stylesheet, Tagr, TagrList, TagrQuery, addDomReadyListener, fromCamelCase, getElementUUID, n, tagr, toCamelCase, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  tagr.Tagr = Tagr = (function(_super) {
    ...
    Tagr.prototype.get = function(k) {
      var _ref;
      return this._node[(_ref = tagr.ATTR_PROPS[k]) != null ? _ref : k];
    };
    ...
    Tagr.prototype.set = function(k, v) {
      ...
      return this._node[(_ref = tagr.ATTR_PROPS[k]) != null ? _ref : k] = v;
    };
  ...
  tagr.TagrQuery = TagrQuery = (function(_super) {
    ...
    function TagrQuery(ctx, match) {
      ...
      this.style = new ArrayHash(this, {
        set: function(k, v) {
          var s, selector;
          selector = "[data-tagr='" + (_this.ctx._ensureAttrUuid()) + "'] " + _this.match;
          s = getStylesheet();
