...
(function() {
  var ArrayHash, DomMap, EventEmitter, HTML_DOM_PROPS, SIMPLE_SELECTOR_CHUNKER, SIMPLE_SELECTOR_MATCH, Script, Stylesheet, Tagr, addDomReadyListener, findBySelector, fromCamelCase, getComputedStyle, getElementUniqueId, keyListable, mappable, n, parseSimpleSelector, tagr, toCamelCase, valueListable, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  ArrayHash = (function() {
    ...
    ArrayHash.prototype.set = mappable(keyListable(valueListable(function(k, v) {
      var _ref;
  ...
  tagr.parse = function(str) {
    ...
    return (_ref = tagr.create(simple, attrs)).append.apply(_ref, (function() {
  ...
  tagr.Tagr = Tagr = (function(_super) {
    ...
    Tagr.prototype._ensureAttrUuid = function() {
      if (!this._node.hasAttribute('data-tagr')) {
        this._node.setAttribute('data-tagr', getElementUniqueId(this._node));
      }
    ...
    Tagr.prototype.set = mappable(function(k, v) {
      var _ref;
