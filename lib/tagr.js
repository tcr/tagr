...
(function() {
  var ArrayHash, DomMap, EventEmitter, HTML_DOM_PROPS, SIMPLE_SELECTOR_CHUNKER, SIMPLE_SELECTOR_MATCH, Script, Stylesheet, TagrElement, addDomReadyListener, findBySelector, fromCamelCase, getComputedStyle, getElementUniqueId, keyListable, mappable, n, parseSimpleSelector, spliceObject, tagr, toCamelCase, valueListable, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  tagr.TagrElement = TagrElement = (function(_super) {
    ...
    TagrElement.prototype._ensureAttrUuid = function() {
