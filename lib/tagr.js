...
(function() {
  var ArrayHash, DomMap, ElementAnchor, EventEmitter, HTML_DOM_PROPS, SIMPLE_SELECTOR_CHUNKER, SIMPLE_SELECTOR_MATCH, Script, Stylesheet, TagrElement, TextAnchor, VOID_ELEMS, addDomReadyListener, convertAnchor, escapeHTML, findBySelector, fromCamelCase, getComputedStyle, getElementUniqueId, keyListable, mappable, n, parseSimpleSelector, spliceObject, tagr, toCamelCase, valueListable, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  VOID_ELEMS = ['area', 'base', 'br', 'col', 'command', 'embed', 'hr', 'img', 'input', 'keygen', 'link', 'meta', 'param', 'source', 'track', 'wbr'];
  ...
  tagr['TagrElement'] = TagrElement = (function(_super) {
    ...
    function TagrElement(_node, parent) {
      var attr, c, i, name, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
        _this = this;
      this._node = _node;
      this.parent = parent;
      this["tag"] = this._node.nodeName.toLowerCase();
      this["props"] = new ArrayHash(this, {
        set: function(k, v) {
          var _ref;
          _this["emit"]('change:' + k, v);
          return _this._node[(_ref = HTML_DOM_PROPS[k]) != null ? _ref : k] = v;
        },
        get: function(k) {
          var _ref;
          return _this._node[(_ref = HTML_DOM_PROPS[k]) != null ? _ref : k];
        },
        remove: function(k) {
          return _this._node.removeAttribute(k);
        }
      });
      ...
      _ref1 = this._node.className.match(/\S+/g) || [];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        name = _ref1[_j];
      ...
      this["style"] = new ArrayHash(this, {
        set: function(k, v) {
          try {
            return _this._node.style[toCamelCase(k)] = v.replace(/^\s*([\S\s]*?)\s*$/, '$1');
          } catch (e) {
    ...
    TagrElement.prototype["set"] = function(k, v) {
      return this["props"].set(k, v);
    };
    ...
    TagrElement.prototype["indexOf"] = function(t) {
      var c, i, _i, _len;
      for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
        c = this[i];
        if (c === t) {
    ...
    TagrElement.prototype["toHTML"] = function() {
      ...
      str.push.apply(str, ['>'].concat(__slice.call((function() {
        ...
        this.style = new ArrayHash(this, {
          set: mappable(keyListable(valueListable(function(k, v) {
            ...
            if (s.insertRule != null) {
              ...
              s.addRule("." + (_this.ctx._ensureUuidClass()) + " " + _this.selector, "" + k + ": " + v);
            }
            return _this;
          })))
        });
